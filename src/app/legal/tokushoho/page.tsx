...
const rows = [
  ...
  { label: "クーリングオフについて", value: "通信販売（インターネット販売）にはクーリングオフ制度は適用されません。ただし当社では、お客様の安心をご提供するため、商品到着後7日以内の返品に任意で応じております。" },
  { label: "注文のキャンセルについて", value: "注文確定後のキャンセルは、商品発送前であればお問い合わせフォームよりご連絡ください。発送後のキャンセルは原則として承ることができませんが、未開封の商品については返品の申請が可能です。" },
];
